            ...
            children: [
              ...
              Expanded(
                ...
                child: Container(
                  ...
                  child: Text(snapshot.data[i].name,style: TextStyle(wordSpacing: 2,fontWeight: FontWeight.bold,
  ...
  child:   Container(
    ...
    children: [
     ...
     Navigator.of(context).push(MaterialPageRoute(builder: (context)=>DoctorProfile(
       ...
       name: snapshot.data[i].name,email: snapshot.data[i].email,address: snapshot.data[i].address,age: snapshot.data[i].age,
       ...
       qualifications: snapshot.data[i].qualificatios,path: snapshot.data[i].path,phone_number: snapshot.data[i].phone,
